...
Supported Models:
- flow_matching: Standard Flow Matching model
...
def load_model_from_checkpoint(checkpoint_path: str, model_cfg: DictConfig, 
    ...
    if model_type == 'flow_matching_ar':
        ...
        raise ValueError(f"Unknown model type: {model_type}. "
                        f"Supported types: flow_matching, flow_matching_ar, "
                        f"flow_matching_ar_bootstrap, unet_ar")
...
def run_ar_bootstrap_inference_batch(
    ...
    with torch.no_grad():
        for seg_i in tqdm(range(num_segments), desc="AR Bootstrap Inference"):
            ...
            # Bootstrap initial state from history
            current_cond_0 = cond_seq_extracted[:, 0]  # [B, C_cond, H, W]
            bootstrapped_state = model.bootstrap_initial_state(
                cond_hist_extracted, current_cond_0
            )
            
            # Run autoregressive rollout for this segment
...
def main():
    ...
    parser.add_argument('--checkpoint', type=str,
                        ...
                        default="/share/crsp/lab/amowli/xianwz2/logs/bubblefusion_logs/flow_matching_32_256_2_False_velocity_from_interface_pb_subcooled_singlestep_none_ds4_47835444/checkpoints/epoch=46-step=078208.ckpt",
                        # Level 2
                        # default="/share/crsp/lab/amowli/xianwz2/logs/bubblefusion_logs/flow_matching_ar_32_256_2_False_ar_ss_noisy_velocity_from_interface_pb_subcooled_singlestep_none_ds4_47835478/checkpoints/last.ckpt",
    ...
    # Output
    parser.add_argument('--output-dir', type=str, default='./ICML/Level_1/Task_2',
    ...
    parser.add_argument('--model-type', type=str, default='auto',
                        choices=['flow_matching', 'flow_matching_ar', 'flow_matching_ar_bootstrap',
                                'unet_ar', 'auto'],
                        help='Model type: flow_matching, flow_matching_ar, flow_matching_ar_bootstrap, '
                             'unet_ar, or auto (detect from path)')
    ...
    parser.add_argument('--initial-state-mode', type=str, default='zeros',
    ...
    try:
        ...
        dataset = load_dataset(
            ...
            normalization_stats=normalization_stats  # Use SAME stats as training!
        )
